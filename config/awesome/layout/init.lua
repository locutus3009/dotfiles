    ...
    for s in screen do
        if s.selected_tag then
            ...
            if s.control_center then
                ...
                elseif not fullscreen and not s.control_center.visible and
                    s.control_center_show_again then
                    s.control_center:toggle()
                    s.control_center_show_again = false
                end
            end
            if s.info_center then
                ...
                elseif not fullscreen and not s.info_center.visible and
                    s.info_center_show_again then
                    s.info_center:toggle()
                    s.info_center_show_again = false
                end
            end
...
tag.connect_signal('property::selected',
                   function(t) update_bars_visibility() end)
