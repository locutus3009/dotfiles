...
local check_disturb_status = function()
    awful.spawn.easy_async_with_shell('cat ' .. widget_dir .. 'disturb_status',
                                      function(stdout)
        ...
        elseif status:match('false') then
            ...
            dont_disturb_state = false
            awful.spawn.with_shell('echo \'false\' > ' .. widget_dir ..
                                       'disturb_status')
        end
...
local toggle_action = function()
    ...
    awful.spawn.easy_async_with_shell(
        'echo ' .. tostring(dont_disturb_state) .. ' > ' .. widget_dir ..
            'disturb_status', function() update_widget() end)
end
