...
-- Screen	WIDTHxHEIGHT
user_preferences.user_resolution = config.widget.screen_recorder.resolution or
                                       '1366x768'
...
-- String 	$HOME
user_preferences.user_save_directory = config.widget.screen_recorder
                                           .save_directory or
                                           '$(xdg-user-dir VIDEOS)/Recordings/'
