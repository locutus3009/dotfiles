...
ruled.client.connect_signal('request::rules', function()
    ruled.client.append_rule {
        id = 'quake_terminal',
        rule_any = {instance = {'QuakeTerminal'}},
...
local quake_close = function() quake_client.hidden = true end
...
awesome.connect_signal('module::quake_terminal:toggle',
                       function() quake_toggle(); end)

client.connect_signal('manage', function(c)
    if c.pid == quake_id then quake_client = c end
end)
