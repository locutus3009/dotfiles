...
local editorGui = os.getenv("VISUAL") or "emacsclient -c -a emacs" or
                      "emacs -nw"
local browser_google = "google-chrome-stable"
local browser_google_flags =
    " --high-dpi-support=1 --force-device-scale-factor=1 --enable-extensions --embed-flash-fullscreen  --ignore-gpu-blacklist --password-store=basic --proxy-server=\"127.0.0.1:3128\""
...
return {
    ...
    default = {
        ...
        rofi_global = 'rofi -dpi ' .. screen.primary.dpi ..
            ...
            '/configuration/rofi/global/rofi-spotlight.sh' .. ' -theme ' ..
            config_dir .. '/configuration/rofi/global/rofi.rasi',
        -- Default app menu
    ...
    run_on_start_up = {
        ...
        -- Load X colors
        'xrdb $HOME/.Xresources', -- Audio equalizer
