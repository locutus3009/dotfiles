...
tag.connect_signal('request::default_layouts', function()
    awful.layout.append_default_layouts({
        ...
        awful.layout.suit.tile.top, awful.layout.suit.floating,
        awful.layout.suit.max, awful.layout.suit.corner.nw,
        awful.layout.suit.corner.sw, awful.layout.suit.magnifier
    })
end)
