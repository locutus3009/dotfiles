...
naughty.config.icon_dirs = {
    ...
    '/usr/share/icons/Papirus/', '/usr/share/icons/la-capitaine-icon-theme/',
    '/usr/share/icons/gnome/', '/usr/share/icons/hicolor/',
    '/usr/share/pixmaps/'
}
...
naughty.connect_signal('request::display', function(n)
    ...
    if _G.dont_disturb_state or
        (focused.info_center and focused.info_center.visible) then
