...
local create_vertical_bar = function(c, pos, bg, size)
    ...
    awful.titlebar(c, {position = pos, bg = bg, size = size}):setup{
        ...
        {buttons = create_click_events(c), layout = wibox.layout.flex.vertical},
        {
            {
...
client.connect_signal('request::titlebars', function(c)
    ...
    if c.type == 'normal' then
        ...
        elseif c.class == 'firefox' then
            create_vertical_bar(c, 'left', beautiful.background,
                                beautiful.titlebar_size)

        elseif c.class == 'XTerm' or c.class == 'UXTerm' then
            create_horizontal_bar(c, 'top', beautiful.xresources
                                      .get_current_theme().background,
                                  beautiful.titlebar_size)
        ...
        elseif c.class == 'Ettercap' then
            create_vertical_bar(c, 'left',
                                beautiful.gtk.get_theme_variables().base_color,
                                beautiful.titlebar_size)
        ...
        elseif c.class == 'Nemo' then
            create_horizontal_bar(c, 'top', beautiful.gtk.get_theme_variables()
                                      .base_color, beautiful.titlebar_size)
    ...
    elseif c.type == 'dialog' then
        ...
        if c.role == 'GtkFileChooserDialog' then
            create_vertical_bar_dialog(c, 'left', beautiful.gtk
                                           .get_theme_variables().bg_color,
                                       beautiful.titlebar_size)
        ...
        elseif c.class == 'Arandr' then
            ...
            create_vertical_bar_dialog(c, 'left', '#00000099',
                                       beautiful.titlebar_size)
        end
