...
local screen_rec_backend = require(
                               'widget.screen-recorder.screen-recorder-scripts')
...
local sr_navigation_reset = function()
    if sr_screen then
        ...
        local recorder_settings = sr_screen:get_children_by_id(
                                      'recorder_settings')[1]
...
local counter_timer = function()
    ...
    countdown_timer = gears.timer.start_new(1, function()
        if seconds == 0 then
            ...
            sr_main_imgbox:set_image(widget_icon_dir .. 'recorder-countdown' ..
                                         '.svg')
