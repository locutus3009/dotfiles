...
local ffmpeg_start_recording = function(audio, filename)
    ...
    ffmpeg_pid = awful.spawn.easy_async_with_shell([[		
		...
		ffmpeg -video_size ]] .. scripts_tbl.user_resolution .. [[ -framerate ]] ..
                                                       scripts_tbl.user_fps ..
                                                       [[ -f x11grab \
		-i :0.0+]] .. scripts_tbl.user_offset .. ' ' .. add_audio_str ..
...
scripts_tbl.stop_recording = function() ffmpeg_stop_recording() end
