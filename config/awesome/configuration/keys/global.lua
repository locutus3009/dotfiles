...
local popup = awful.popup {
    widget = {
        {language_text_widget, layout = wibox.layout.fixed.vertical},
        margins = 10,
...
local global_keys = awful.util.table.join( -- Hotkeys
        ...
        group = 'layout'
    }), awful.key({modkey}, 'o', function() awful.tag.incgap(1) end,
    ...
    end, {description = 'open default music player', group = 'hotkeys'}),
    ...
    -- ALSA volume control
        ...
        awful.spawn('rofi -show window', false)
    end, {description = 'switch apps', group = 'hotkeys'}),
        ...
        awful.spawn
            .easy_async_with_shell(apps.utils.full_screenshot, function() end)
    end, {description = 'fullscreen screenshot', group = 'Utility'}),
                        awful.key({modkey, 'Shift'}, 's', function()
        awful.spawn
            .easy_async_with_shell(apps.utils.area_screenshot, function() end)
    ...
    end, {description = 'open global search', group = 'launcher'}),
